...
function HomeHero() {
  ...
  return (
    <main
      ref={containerRef}
      className="relative  bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 pt-34 pb-20 overflow-hidden transition-colors duration-300"
    >
      {/* Background Elements */}
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div
              ref={trustBadgeRef}
              className="flex items-center gap-2 bg-white dark:bg-gray-800/90 backdrop-blur rounded-full px-4 py-2 shadow-sm border border-gray-200 dark:border-gray-700 w-fit transition-colors duration-300"
            >
            ...
            <div className="space-y-4">
              <h1
                ref={headlineRef}
                className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 dark:text-white transition-colors duration-300"
              >
                Where
                <span className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent bg-[length:200%_100%]">
                  {" "}
                  talent{" "}
                </span>
                meets
                <span className="bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent bg-[length:200%_100%]">
                  {" "}
                  opportunity
                </span>
              </h1>
              <p
                ref={subtitleRef}
                className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl transition-colors duration-300"
              >
                Whether you&apos;re hiring top talent or showcasing your skills,
                FreeLanceBase connects the right people for every project. Join
                millions of freelancers and clients worldwide.
              </p>
            </div>
            ...
            <div ref={popularSectionRef} className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={tag}
                    className="px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 dark:text-blue-300 rounded-full text-sm font-medium transition-all duration-200 border border-blue-200 dark:border-blue-800 hover:border-blue-300 dark:hover:border-blue-700"
                  >
                    {tag}
                  </button>
                ))}
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-4 transition-colors duration-300">
                Popular for freelancers:
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  "Remote Jobs",
            ...
            >
              ...
              <Link href="/freelancers">
                <Button className="cursor-pointer bg-white dark:bg-gray-800 border-2 border-blue-600 dark:border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 px-8 py-4 rounded-xl font-semibold shadow-md hover:shadow-lg transition-all duration-200 text-lg group">
                  <span className="inline-flex items-center">
                    Browse Freelancers
                    <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </span>
          ...
          <div className="relative">
            ...
            <div
              ref={visualRef}
              className="relative bg-gradient-to-br from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-3xl shadow-2xl overflow-hidden transition-colors duration-300"
            >
              <div className="aspect-[4/3] bg-gradient-to-br from-blue-400 to-indigo-500 dark:from-blue-500 dark:to-indigo-600 flex items-center justify-center transition-colors duration-300">
                <div className="text-center text-white p-8">
                  ...
                  <p className="text-blue-100 dark:text-blue-50 transition-colors duration-300">
            ...
            <div
              ...
              className="hidden lg:block absolute -top-6 -left-4 lg:-left-6 bg-white dark:bg-gray-800/90 backdrop-blur rounded-2xl shadow-lg p-4 border border-gray-100 dark:border-gray-700 transition-colors duration-300"
            >
            ...
            <div
              ...
              className="hidden lg:block absolute -bottom-6 -right-4 lg:-right-6 bg-white dark:bg-gray-800/90 backdrop-blur rounded-2xl shadow-lg p-4 border border-gray-100 dark:border-gray-700 transition-colors duration-300"
            >
              <div className="flex items-center gap-3">
            ...
            <div
              ...
              className="hidden lg:block absolute top-1/2 -left-6 lg:-left-8 -translate-y-1/2 transform bg-white dark:bg-gray-800/90 backdrop-blur rounded-2xl shadow-lg p-4 border border-gray-100 dark:border-gray-700 transition-colors duration-300"
            >
              <div className="flex items-center gap-3">
